...
# MonoSBM with estimated memberships, K=2, d=1, rho=sqrt(log(n))/n, L=100, n=1000
...
res_spec <- specEmbed(d=1, K=K, Abar=res$Abar, Zhat=res$Z, B=Bmat, sparseRho=sparseRho)
